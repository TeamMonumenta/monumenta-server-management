 ...
 * interface; callers see only chunk coordinates and NBT.
 *
...
public interface WorldStorageAdapter {
	// Opens an existing region file (region/ or entities/) read-write for in-place chunk rewriting.
	// Must be pointed at a copy, never at a template that has to stay untouched.
